...
import { StyleSheet, Image, ScrollView, KeyboardAvoidingView, Switch, TextInput } from 'react-native';
...
export default class Settings extends React.Component {
  ...
  render(){
    ...
    return (
      <KeyboardAvoidingView style={styles.settings} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
