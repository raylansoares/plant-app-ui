...
import { StyleSheet, Dimensions, ScrollView, TouchableOpacity, Image, Animated } from 'react-native';
  ...
  render(){
    ...
    return (
      <Block style={styles.explore}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.explorer}>
          {this.renderExplore()}
        </ScrollView>
